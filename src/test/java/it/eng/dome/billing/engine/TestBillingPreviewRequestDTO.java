...
public class TestBillingPreviewRequestDTO {
	...
	public static void main(String[] args) {
		...
		String percorsoFile = "C:\\Users\\sdagosti\\dome-workspace\\billing-engine\\src\\test\\java\\sanple-data\\TestPayPerUse\\BillingPreviewRequestDTO_example.json";
		...
		try {
			...
			System.out.println(bprDTO.toJson());
